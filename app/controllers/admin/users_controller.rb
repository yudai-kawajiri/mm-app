...
class Admin::UsersController < Admin::BaseController
  ...
  def create
    ...
    if @user.save
      ...
      redirect_to admin_user_path(company_slug_for_redirect, @user), notice: t("flash_messages.admin.users.messages.created")
    else
  ...
  def update
    ...
    if @user.update(update_params)
      redirect_to admin_user_path(company_slug_for_redirect, @user), notice: t("flash_messages.update.success", resource: User.model_name.human)
    else
  ...
  def destroy
    ...
    if @user.id == current_user.id
      redirect_to admin_users_path(company_slug_for_redirect), alert: t("flash_messages.admin.users.messages.cannot_delete_self"), status: :see_other
      return
    end

    @user.destroy!
    redirect_to admin_users_path(company_slug_for_redirect), notice: t("flash_messages.destroy.success", resource: User.model_name.human), status: :see_other
  end
