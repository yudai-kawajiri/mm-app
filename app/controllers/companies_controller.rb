  ...
  def switch
    ...
    if company_id
      ...
      if company
        ...
        flash[:notice] = t("flash_messages.admin.companies.messages.switch_success", company_name: company.name)
      ...
      flash[:notice] = t("flash_messages.admin.companies.messages.switch_all_companies")
