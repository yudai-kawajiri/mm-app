...
class Resources::ProductsController < AuthenticatedController
  ...
  def purge_image
    ...
    respond_to do |format|
      format.html { redirect_to edit_company_resources_product_path(company_slug: current_company.slug, id: @product.id), notice: t("resources.products.messages.image_deleted") }
