class AddCompanyAndStoreToCategories < ActiveRecord::Migration[8.1]
  def change
    ...
    reversible do |dir|
      dir.up do
        ...
        if company_id && store_id
          execute "UPDATE categories SET company_id = #{company_id}, store_id = #{store_id} WHERE company_id IS NULL"
        end
      end
    end
