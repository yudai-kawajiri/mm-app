ActiveRecord::Schema[8.1].define(version: 2026_01_09_085154) do
  ...
  create_table "companies", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.string "name", null: false
    t.string "phone"
    t.boolean "portfolio_demo", default: false, null: false
    ...
    t.index ["portfolio_demo"], name: "index_companies_on_portfolio_demo"
