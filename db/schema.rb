...
ActiveRecord::Schema[8.1].define(version: 2025_12_16_045800) do
  ...
  create_table "daily_targets", force: :cascade do |t|
    ...
    t.index ["tenant_id"], name: "index_daily_targets_on_tenant_id"
  ...
  create_table "plan_products", force: :cascade do |t|
    ...
    t.index ["tenant_id"], name: "index_plan_products_on_tenant_id"
  end
  ...
  create_table "product_materials", force: :cascade do |t|
    ...
    t.index ["tenant_id"], name: "index_product_materials_on_tenant_id"
  ...
  add_foreign_key "daily_targets", "tenants"
  add_foreign_key "daily_targets", "users"
  add_foreign_key "material_order_groups", "stores"
  add_foreign_key "material_order_groups", "tenants"
  ...
  add_foreign_key "product_materials", "tenants"
